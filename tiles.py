...
from turtle import up, goto, down, color, begin_fill, done
from turtle import forward, left, end_fill, write, onscreenclick
from turtle import update, setup, hideturtle, tracer
